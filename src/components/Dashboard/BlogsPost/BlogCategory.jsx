...
import {getCategory,addCategory} from '../../../Redux/Fetures/Reducers/CategorySlice'
            ...
            <div className='   w-[100%] h-[100vh] flex flex-col-2 gap-4 bgGradient  '>
                ...
                <div className=' w-full  '>
                    ...
                    <div className=' my-4 pr-4 '>
                        <h1 className='text-center text-2xl underline underline-offset-8 font-bold'>Blog Category</h1>
                                    ...
                                    <tbody>
                                        ...
                                        <tr key={index} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class=" flex justify-center items-center pt-2">
                                                ...
                                                <button class="bg-transparent hover:bg-red-500 text-red-700 font-medium hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded-full">
                                                    delete
                                                </button>
                                            </td>
                                        </tr>
