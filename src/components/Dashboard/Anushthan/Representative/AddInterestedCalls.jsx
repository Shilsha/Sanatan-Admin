...
const AddInterestedCalls = () => {
    ...
    return (
        <div>
            <a onClick={openModal}>+ Interested Calls</a>
            <Modal
                isOpen={modalIsOpen}
            ...
            >
                ...
                <div className="div">
                    <form class="bg-white shadow-md rounded px-8 pt-2 pb-8 " >
                        ...
                        <h1 className='text-center font-sans  mb-4 text-2xl font-bold text-orange-500'>Add Interested Calls</h1>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="mb-4">
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="adminEmail" type="email" placeholder="Interested" required name='email' value={form.email} onChange={handleChangeInput}
                                />
                                {/* {resError && (<p className='text-red-500 text-sm pt-1'>{resError}</p>)} */}
                            </div>
                            <div className='mb-4'>
...
export default AddInterestedCalls