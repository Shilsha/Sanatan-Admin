...
export const getBlogReviewAction = createAsyncThunk('GET_BLOGS_REVIEW/GET_BLOGS_REVIEW',
    async (props) => {
        ...
        let OPTIONS = {
            url: `${import.meta.env.VITE_BASE_URL}/article/openAndPublishBlogs?title=${props.keyword}&articleType=OPEN&isDraftBlog=false&status=true&page=${props.page}&size=10`,
            method: "GET",                       
            headers: {
